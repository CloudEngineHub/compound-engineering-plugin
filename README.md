...
| [`/ce-commit-push-pr`](docs/skills/ce-commit-push-pr.md) | Commit, push, and open a PR (or opt-in managed stack) that teaches any concept the change newly introduces |
